...
function Employee({details, deleteEmployeeCallBack, saveEmployeeCallBack}){
    ...
    const handleOnDeleteClick = () => {
        console.log(details);
        deleteEmployeeCallBack(details.idEmployee)
    }
    ...
    const handleOnSaveClick = async  () => {
        setLoading(true);
         await saveEmployeeCallBack(data);
             setLoading(false);
             setIsModeEdit(false)
         }
                ...
                <div>Loading...</div> : (
                    ...
                    {isModeEdit ? (
                        <>
                            ...
                            <>
                                <h1><label >FirstName : {details.firstName}</label></h1>
                               <p><label >LastName : {details.lastName}</label></p> 
                               <p><label >Password : {details.password}</label></p> 
                               <p><label >CIN : {details.cin}</label></p> 
                               <p><label >Email : {details.email}</label></p>
