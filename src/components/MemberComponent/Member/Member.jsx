...
function Member({details, fonction, deleteMemberCallBack, saveMemberCallBack }){
    ...
    const handleOnDeleteClick = () => {
        console.log(details);
        deleteMemberCallBack(details.idMember)
    }
                ...
                <div>Loading...</div> : (
                    ...
                    {isModeEdit ? (
                        <>
                            ...
                            <select defaultValue={fonction && fonction[0]} name='fonction' onChange={handleOnChange}>{fonction?.map(fonction => <option key={fonction} value={fonction}>{fonction}</option>)}</select ><br/>

                            <button onClick={handleOnSaveClick}>Save</button>
                        </>
                    ) : (
                            <>
                                <label >First name : {details.firstName} </label><br/>
                                <label >Last name :  {details.lastName}</label><br/>
                                <label >CIN :  {details.cin}</label><br/>
                                <label >Email :  {details.email}</label><br/>
                                <label >Address :  {details.address}</label><br/>
                                <label >Date Membership :  {details.dateOfMembership}</label><br/>
                                <label >function :  {details.fonction}</label><br/>
                                <label >Id Subscription Membership :  {details.subscription}</label><br/>
