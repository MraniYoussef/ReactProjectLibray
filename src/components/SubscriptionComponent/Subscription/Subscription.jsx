...
function Subscription({details, deleteSubscriptionCallBack, saveSubscriptionCallBack}){
    ...
    const handleOnDeleteClick = () => {
        console.log(details);
        deleteSubscriptionCallBack(details.idSubscription)
    }
    ...
    const handleOnSaveClick = async  () => {
        setLoading(true);
         await saveSubscriptionCallBack(data);
             setLoading(false);
             setIsModeEdit(false)
         }
                ...
                <div>Loading...</div> : (
                    ...
                    {isModeEdit ? (
                        <>
                            ...
                            <input name='idMember' value={data.idMember} onChange={handleOnChange} />
